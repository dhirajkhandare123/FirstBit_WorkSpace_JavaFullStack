...
//		System.out.println("Actions: "+this.actionPerform());
//	}
}
...
class Actor extends Artist{
	...
	String actionPerform() {
		return "Performing actions in movie..........";
	}
...
public class FbsPolymorphism05 {

	public static void main(String[] args) {
		
		Artist a1;
		
		a1 = new Painter("Om", 20, "Expressionism", "watercolor", 130);
		//a1.display();
		System.out.println(a1.toString());
		
		System.out.println();
		
		a1 = new Musician("Keshav", 24, "Guitar", "Devotional songs", 20);
		//a1.display();
		System.out.println(a1.toString());
		
		System.out.println();
		
		a1 = new Actor("Tony Stark", 43, "Bollywood", 51);
		//a1.display();
		System.out.println(a1.toString());
	}
