...
public class FbsPolymorphism02 {

	public static void main(String[] args) {
		
		Vehicle v1;
		
		v1 = new Bike("MH28AB5095", "KTM", "KTM AG", 2, 120000, 2, 1, "Sport Bike");
		v1.display();
		
		System.out.println();
		
		v1 = new Car("MH28JJ3012", "Nano", "Tata", 4, 100000, false, "Normal", 0);
		v1.display();
