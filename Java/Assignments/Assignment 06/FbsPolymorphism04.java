...
public class FbsPolymorphism04 {

	public static void main(String[] args) {
		
		Player p1;
		
		p1 = new CricketPlayer("Sachin Tendulkar", 56, "India", 410, 10, 17000, 13, "Right Handed", "Right Arm Spin");
		p1.display();
		
		System.out.println();
		
		p1 = new FootballPlayer("Krishna Ronaldo", 39, "Portugal", 523, 7, 810, "Left Winger");
		p1.display();
